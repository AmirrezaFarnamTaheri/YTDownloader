...
def test_download_video_generic_fallback(mock_ytdlp_wrapper, mock_generic_downloader, mock_telegram_extractor, mock_disk_space, mock_shutil):
...
def test_download_video_ytdlp(mock_ytdlp_wrapper, mock_generic_downloader, mock_telegram_extractor, mock_disk_space, mock_shutil):
    options = MagicMock(spec=DownloadOptions)
