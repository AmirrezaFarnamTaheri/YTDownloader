...
class TestGenericDownloader(unittest.TestCase):
    ...
    def test_telegram_extractor_success(self, mock_get):
        ...
        self.assertEqual(info['video_streams'][0]['url'], "https://cdn.telegram.org/file/video.mp4")

    @responses.activate
    def test_download_generic_success(self):
        url = "http://example.com/file.mp4"
        responses.add(responses.GET, url, body=b'0'*1024, stream=True, content_type='video/mp4', headers={'Content-Length': '1024'})
