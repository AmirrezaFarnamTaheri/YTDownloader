...
class TestMainIntegration(unittest.TestCase):
    ...
    def test_download_task_success(self, mock_add_history, mock_download):
        ...
        def side_effect_download(*args, **kwargs):
            ...
            progress_hook({'status': 'downloading', 'downloaded_bytes': 50, 'total_bytes': 100, 'speed': 100, 'eta': 1}, item)
    ...
    def test_process_queue_scheduler(self, mock_download_task):
        ...
        self.assertTrue(mock_download_task.called or item['status'] == 'Allocating' or item['status'] == 'Downloading')
